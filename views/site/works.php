...
?>
<?
$array = array_combine($objects, $objects);
?>
<h1>Новая запись:</h1>

<?php $form = ActiveForm::begin();?>

		<?php echo $form->field($model, 'object')->dropDownList($array, [ 'prompt' => 'Выберете объект'])->label('Объект'); ?>
		<?php echo $form->field($model, 'work')->textarea(['maxlength' => true])->label('Название работ'); ?>
